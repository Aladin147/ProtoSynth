...
def evolve_main():
    ...
    parser.add_argument("--env", required=True, help="Environment name (periodic_k4, markov_k2)")
    ...
    parser.add_argument("--lambda", dest="lambda_", type=int, default=48, help="Offspring size")
    ...
    try:
        for gen in range(args.gens):
            ...
            if args.verbose or gen % 10 == 0:
                print(f"Gen {gen:3d}: F_best={current_best:.6f}, "
            ...
            for key, value in best_individual.metrics.items():
                ...
                if isinstance(value, (dict, list, tuple)):
                    try:
                        ...
                        serializable_metrics[key] = str(value)  # Convert to string if not
                else:
                    serializable_metrics[key] = value
